...
$graphs = [
    'appointments'      => ['../analytics_graph/appointments_graph_admin.php', 'Appointments Trend'],
    'payments'          => ['../analytics_graph/payments_graph_admin.php', 'Monthly Revenue'],
    'services'          => ['../analytics_graph/services_graph_admin.php', 'Service Usage Trend'],
    'stock_threshold'   => ['../analytics_graph/stock_threshold_graph_admin.php', 'Stock Thresholds'],
    // REMOVED: 'low_stock' => ['../analytics_graph/supply_graph.php', 'Low Stock Items'],
    'user_logins'       => ['../analytics_graph/userlog_graph_admin.php', 'User Logins']
];
