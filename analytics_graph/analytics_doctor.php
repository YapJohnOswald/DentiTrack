...
$graphs = [
    'appointments'      => ['../analytics_graph/appointments_graph_doctor.php', 'Appointments Trend'],
    'payments'          => ['../analytics_graph/payments_graph_doctor.php', 'Monthly Revenue'],
    'services'          => ['../analytics_graph/services_graph_doctor.php', 'Service Usage Trend'],
    'stock_threshold'   => ['../analytics_graph/stock_threshold_graph_doctor.php', 'Stock Thresholds'],
