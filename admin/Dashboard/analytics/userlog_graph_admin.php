...
if (file_exists('analytics/graph_conn.php')) {
    include 'analytics/graph_conn.php';
} else {
...
<body class="bg-light-gray font-sans min-h-screen p-4 sm:p-8">
    ...
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="bg-white p-4 md:p-6 rounded-xl shadow-lg border border-gray-200">
            <form method="GET" action="analytics/analytics_admin.php" class="flex flex-col sm:flex-row items-center justify-between gap-4">
