...
$graphs = [
    'appointments'      => ['analytics/appointments_graph_admin.php', 'Appointments Trend'],
    'payments'          => ['analytics/payments_graph_admin.php', 'Monthly Revenue'],
    'services'          => ['analytics/services_graph_admin.php', 'Service Usage Trend'],
    'stock_threshold'   => ['analytics/stock_threshold_graph_admin.php', 'Stock Thresholds'],
    // REMOVED: 'low_stock' => ['../analytics/supply_graph.php', 'Low Stock Items'],
    'user_logins'       => ['analytics/userlog_graph_admin.php', 'User Logins']
];
...
$selected_graph_file = $graphs[$view][0];
...
$_GET['service_id'] = isset($_GET['service_id']) ? (int)$_GET['service_id'] : 1; 
...
<div class="dentrack-main-container">
    <div class="dentrack-graph-area">
        <div>
            ...
            if (file_exists($selected_graph_file)) {
